...
export function checkJobsStatusFilter() {
...
export function renderJobDetail(job) {
  return `
    <div class="job-details d-flex align-items center" id="${
      job.id
    }" data-status="${job.status}" data-created="${job.created}">
        <div class="input-group mb-3">
            ...
            <button class="btn btn-outline-secondary edit" id="edit-${job.id}">
                <svg
            ...
            <button class="btn btn-outline-danger delete" id="delete-${job.id}">
                <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
